...
<div id="container">
	...
	<?php include( get_template_directory() . '/templates-navigation/breadcrumbs-menu.php' ); ?>
	 ...
	 <div class="content-width">
            ...
            <h1 class='page-title'>News glrlg le lgaljk;</h1>

            <div id="news-desktop" class="right-content">
            ...
            <div class="left-content">
                ...
                <div class="return-results">
                	...
                	<?php include( get_template_directory() . '/templates-layout/vertical-news-column-section.php' ); ?>
                </div>
...
jQuery(document).ready(function() {
    ...
    */
    ...
    jQuery("body").on("click","#news-sidebar-element .category-list li a",function(){

        item = jQuery(this).parent().parent();
        item_slug = jQuery(this).data('cat');
        jQuery('#news-sidebar-element .category-list li a').removeClass('active');
    ...
    jQuery("body").on("click","#news-sidebar-element .tags h6",function(){

        item = jQuery(this);
        item_slug = jQuery(this).data('tag');
        jQuery('#news-sidebar-element .tags h6').removeClass('active');
    ...
    function getPosts(){
        ...
        jQuery.ajax({
            method: "POST",
            url: "/wp-content/themes/dtn/service/service-news.php",
            dataType:"json",
            ...
            jQuery("#vertical-news-column-section").html(data);
            console.log(data);
